...
- Story 5.2: Contextual tooltips implemented for first-time users with 2-step sequence (weather widget and menu card), local persistence with Hive, app-kill recovery, and best-effort server sync